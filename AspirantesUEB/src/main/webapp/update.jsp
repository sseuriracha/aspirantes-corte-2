...
<body>
    ...
    <div class="formulario">
        <div class="title">
            <h5><b>Actualice los datos del aspirante:</b></h5>
        </div>
        <form action="">
            <div class="tinput">
            ...
            <div class="dinput">
                <input type="text" name="nombreact" style=width:300px; required>
            </div>
            <div class="tinput">
                <h5>Fecha de nacimiento</h5>
            </div>
            <div class="dinput">
                <input type="date" name="fechaact" required>
            </div>
            <div class="tinput">
                <h5>Nombre del colegio del que se graduó</h5>
            </div>
            <div class="dinput">
                <input type="text" name="colegioact" style=width:250px; required>
            </div>
            <div class="tinput">
                <h5>Carrera que desea estudiar</h5>
            </div>
            <div class="dinput">
                <select id="input" onchange="mostrarPrecio(this)" name="carreraact" required>
            ...
            <div class="dinput">
                <input type="number" max="6" min="1" name="estratoact" style=width:100px; required>
            </div>
            <div class="tinput">
                <h5>Homologado</h5>
            </div>
            <div class="dinput">
                <select id="hinput" name="homologadoact" required>
                    <option value="">-Elija una opción-</option>
            ...
            <div class="dinput">
                <input type="file" name="fotoact" style=width:400px; accept="image/png, image/jpeg" required>
            </div>
            <div class="tinput">
                <h5>Actualizar información</h5>
            </div>
            <div class="dinput">
                <input type="submit" name="actualizar" value="Actualizar" style=width:100px;>
            </div>
        </form>
    </div>
